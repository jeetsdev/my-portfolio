					...
					<Col md={8} className="home-about-description">
						...
						<p className="home-about-body">
							...
							<i>
								<b className="purple">
									{" "}
									ReactJS, JavaScript, Redux, Tailwind CSS
								</b>
							</i>
							<br />
							<br />
							...
							<i>
								<b className="purple">
									Rich User Interfaces and Interactive Web
									Apps
								</b>{" "}
							</i>
							<br />
					...
					<Col md={12} className="home-about-social">
						...
						<ul className="home-about-social-links">
							<li className="social-icons">
								<a
									href="https://www.linkedin.com/in/jeetsdev/"
									target="_blank"
							...
							<li className="social-icons">
								<a
									href="https://github.com/jeetsdev"
									target="_blank"
									rel="noreferrer"
									className="icon-colour  home-social-icons"
								>
							...
							<li className="social-icons">
								<a
									href="https://twitter.com/jeetsdev"
									target="_blank"
									rel="noreferrer"
									className="icon-colour  home-social-icons"
								>
